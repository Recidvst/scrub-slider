var Scrub = (function () {
  ...
  function Scrub(scrubArg) {
    ...
    if (isObject(scrubArg) || _typeof(scrubArg) == 'object') {
      // set function default arguments
      scrubArg.target =
        typeof scrubArg.target !== 'undefined' &&
        (isObject(scrubArg) || _typeof(scrubArg) == 'object')
          ? scrubArg.target
          : null
      scrubArg.height =
        typeof scrubArg.height !== 'undefined' &&
        (isObject(scrubArg) || _typeof(scrubArg) == 'object')
          ? scrubArg.height
          : '500px'
      scrubArg.handle =
        typeof scrubArg.handle !== 'undefined' &&
        (isObject(scrubArg) || _typeof(scrubArg) == 'object')
          ? scrubArg.handle
          : true
      scrubArg.src =
        typeof scrubArg.src !== 'undefined' && (isObject(scrubArg) || _typeof(scrubArg) == 'object')
          ? scrubArg.src
          : null
      scrubArg.alt =
        typeof scrubArg.alt !== 'undefined' && (isObject(scrubArg) || _typeof(scrubArg) == 'object')
          ? scrubArg.alt
          : null
      ScrubInitiate()
    } else {
    ...
    function ScrubInitiate() {
      ...
      try {
        var utilityFn = function utilityFn(callback) {
          ...
          var scrubName =
            isObject(scrubArg) || _typeof(scrubArg) == 'object' ? scrubArg.target : scrubArg
